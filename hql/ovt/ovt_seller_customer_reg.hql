...
left join  ovt.man_ovt_dim_customer buyer_cust on ovt_reg.buyer_cust_key = buyer_cust.cust_key and buyer_cust.cust_key >= 0
left join ovt.man_ovt_dim_customer seller_cust on ovt_reg.seller_cust_key = seller_cust.cust_key and seller_cust.cust_key >=0;
